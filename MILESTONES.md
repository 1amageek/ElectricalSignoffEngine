...
| M6 Platform integration | Xcircuite persistence, review, and resume | In integration verification |

Each milestone is proven by executable artifacts and tests. Downstream tool
trust, flow approval, and release authorization are not package milestones.
